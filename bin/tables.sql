...
create table orders (
  ...
  rating varchar(30),
  status varchar(30),
  CONSTRAINT check_status CHECK (status IN ('waiting', 'rejected', 'confirmed')) id_cons bigint not null,
  FOREIGN KEY (id_cons) REFERENCES consumer(id) id_prov bigint not null,
  FOREIGN KEY (id_prov) REFERENCES provider(id)
);